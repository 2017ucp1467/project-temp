...
### 5. From the data set in step 4, created a second, independent tidy data set([tidyData.txt](https://github.com/2017ucp1467/project-temp/blob/master/tidyData.txt, "tidyData.txt")) with the average of each variable for each activity and each subject.
